                            ...
                            <tr>
                                ...
                                <td class="cell">
                                    ...
                                    <div class="col-auto d-inline-block">
                                        <a onclick="copy('{{ rawurlencode($saved_top_message) . '%0A%0A' . rawurlencode($guest->name) . '%0A%0A' . rawurlencode($saved_body_message) . '%0A%0A' . rawurlencode('https:;&#47;&#47;arinindra.diginvee.com/' . $guest->code) . '%0A%0A' . rawurlencode($saved_bottom_message) }}','#copy_button_{{ $guest->id }}')"
